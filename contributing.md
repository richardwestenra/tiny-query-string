...
1. Fork the repository and clone it to your computer, and install dependencies with `npm install`.
2. Tests are in `/test/index.js`. You can run them with `npm test`. Please update the tests if adding new features.
...
5. Please update the minified build with `npm build` before committing and submitting a PR.
...
reported by contacting the project team at richard@richardwestenra.com. All
